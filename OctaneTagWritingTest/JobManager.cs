...
namespace OctaneTagWritingTest
{
    internal class JobManager
    {
        ...
        public JobManager(string hostnameWriter, string hostnameVerifier, string testDescription, ReaderSettings settings)
        {
            ...
            strategies.Add("0", new JobStrategy0ReadOnlyLogging(hostnameWriter, $"TestCase0_Log-{testDescription}.csv", readerSettings));
            strategies.Add("1", new JobStrategy1SpeedStrategy(hostnameWriter, $"TestCase1_Log-{testDescription}.csv", readerSettings));    
            ...
            strategies.Add("3", new JobStrategy3BatchSerializationPermalockStrategy(hostnameWriter, $"TestCase3_Log-{testDescription}.csv", readerSettings));
            ...
            strategies.Add("7", new JobStrategy7OptimizedStrategy(hostnameWriter, $"TestCase7_Log-{testDescription}.csv", readerSettings));
            strategies.Add("8", new JobStrategy8DualReaderEnduranceStrategy(hostnameWriter, hostnameVerifier, $"TestCase8_Log-{testDescription}.csv", readerSettings));
